                ...
                if let descriptionJSON = descriptionElement.content {
                    ...
                    for item in breadcrumbs {
                        if item["item:"]["@type"] == "TVEpisode" {
                            ...
                            newProgram.summary = showMetadata["description"].string ?? "None available"
                            ...
                            newProgram.thumbnailURL = showMetadata["image"]["url"].stringValue
...
//            newProgram.lastBroadcastString = DateFormatter.localizedString(from: timeAired, dateStyle: .medium, timeStyle: .none)
            ...
            if newProgram.episodeName.isEmpty {
                newProgram.episodeName = DateFormatter.localizedString(from: timeAired, dateStyle: .medium, timeStyle: .none)
            }
        }
