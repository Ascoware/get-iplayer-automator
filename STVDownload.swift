...
@objc public class STVDownload : Download {
    ...
    @objc public init(programme: Programme, proxy: HTTPProxy?) {
        ...
        DispatchQueue.main.async {
            ...
            DDLogVerbose("STV: Requesting Metadata")
    ...
    func metaRequestFinished(response: HTTPURLResponse, data: Data?, error: Error?) {
        ...
        let showMetadata = STVMetadataExtractor.getShowMetadata(url: response.url?.absoluteString ?? "", html: responseString)
